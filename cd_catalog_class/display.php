...
<a href="display.php?displayby=genre&displayvalue=Punk">Punk</a><br />
<a href="display.php?displayby=genre&displayvalue=Rock">Rock</a><br />
<a href="display.php?displayby=genre&displayvalue=Alternative Rock">Alternative Rock</a><br />
...
<a href="display.php?displayby=genre&displayvalue=Folk">Folk</a><br />
...
$qry = "SELECT *, LEFT(artist, 1) AS first_char FROM cd_catalog_class 
        WHERE UPPER(artist) BETWEEN 'A' AND 'Z'
        ORDER BY artist";
...
while ($row = mysqli_fetch_assoc($result)) {
    if ($row['first_char'] != $current_char) {
        ...
        echo "<a href=\"display.php?displayby=artist&displayvalue=$thisChar%\">$thisChar</a> | ";
    }  
}
