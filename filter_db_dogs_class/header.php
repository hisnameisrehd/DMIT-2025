...
<div id="links">
	...
	<a href="index.php?displayby=size&displayvalue=large">Large Dogs</a>
	<br />
	<a href="index.php?displayby=size&displayvalue=medium">Medium Dogs</a>
	<br />
	<a href="index.php?displayby=size&displayvalue=small">Small Dogs</a>
	<br />
	...
	<br />
	<h3>Filter by intelligence</h3>
	<a href="index.php?displayby=intelligence&min=1&max=4">Dumb Dogs</a>
	<br />
	<a href="index.php?displayby=intelligence&min=4&max=7">Average Dogs</a>
	<br />
