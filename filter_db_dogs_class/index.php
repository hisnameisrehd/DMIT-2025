...
// $var2 = $_GET['var2'];
// $var3 = $_GET['var3'];
// if($displayby == "intelligence" && $var2 && $var3){
// 	$sql = "SELECT * FROM dogs WHERE...";
// $sql = "SELECT * FROM dogs WHERE $var1 BETWEEN $var2 AND $var3";// SHOW ONLY DOGS FROM ID RANGE
// }

$min = $_GET['min'];
$max = $_GET['max'];
if($displayby == "intelligence" && $min && $max){
	// $sql = "SELECT * FROM dogs WHERE...";
$sql = "SELECT * FROM dogs WHERE intelligence BETWEEN $min AND $max";// SHOW ONLY DOGS FROM ID RANGE
}
